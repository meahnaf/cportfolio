...
Navigation:
  ...
  Ctrl+L       Clear screen`
    ...
    uname: () => ({ output: "Md Ahnaf Ali - Personal Portfolio" }),
    ...
    git: (args) => {
      ...
      const gitCommands = {
        ...
        branch: "* main\n  develop",
        remote: "origin\thttps://github.com/meahnaf/cportfolio.git (fetch)\norigin\thttps://github.com/meahnaf/cportfolio.git (push)"
      };
        ...
        {history.map((entry, index) => (
          <div key={index} className="terminal-entry">
            <div className="terminal-prompt">
              <span className="terminal-user">ahnaf@macbook</span>
